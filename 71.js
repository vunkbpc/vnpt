qa['examinethestructureofthecustomerstable:(choosetwo.)custnoistheprimarykey.youmustdetermineifanycustomers'detailshavebeenenteredmorethanonceusingadifferentcustno,bylistingallduplicatenames.whichtwomethodscanyouusetogettherequiredresult?']=['self-join','subquery']
...
qa['youneedtodisplaythedate11-oct-2007inwordsas"eleventhofoctober,twothousandseven'.whichsqlstatementwouldgivetherequiredresult?']=['selectto_char(to_date('11-oct-2007'),"fmddthsp"of"month,year')fromdual']
...
qa['youwanttodisplaythedateforthefirstmondayofthenextmonthandissuethefollowingcommand:sql>selectto_char(next_day(last_day(sysdate),'mon'),'dd"isthefirstmondayfor"fmmonthrrrr')fromdual;whatistheoutcome?']=['ingeneratesanerrorbecauseto_charshouldbereplacedwithto_date.']
...
']"
"qa['whichthreearetrueaboutmultitableinsertstatements?']=['theycanbeperformedonexternaltablesusingsql*loader.
','theycaninserteachcomputedrowintomorethanonetable.
','theycanbeperformedonrelationaltables.
']"
"qa['examinethestructureoftheprogramstable:whichtwosqlstatementswouldexecutesuccessfully?']=['selectnvl(months_between(start_date,end_date),'ongoing')fromprograms;
','selectto_date(nvl(sysdate-end_date,sysdate))fromprograms;
']"
...
']"
"qa['whichstatementistrueabouttheoraclesql,deleteandtruncatestatements?
']=['deletebutnottruncatestatementcanbeusedtoremovedatafromselectivecolumnsandrowsofatable.
']"
"qa['theorderstablehasaprimarykeyconstraintontheorder_idcolumn.theorder_itemstablehasaforeignkeyconstraintontheorder_idcolumn,referencingtheprimarykeyoftheorderstable.theconstraintisdefinedwithondeletecascade.therearerowsintheorderstablewithanorder_totaloflessthan1000.whichthreedeletestatementsexecutesuccessfully?
']=['deleteorder_idfromorderswhereorder_total<1000;
','delete*fromorderswhereorder_total<1000;
']"
"qa['whichtaskcanbeperformedbyusingasingledatamanipulationlanguage(dml)statement?
']=['removingalldataonlyfromasinglecolumnonwhichaprimarykeyconstraintisdefined
']"
"qa['whichthreeactionscanyouperformonlywithsystemprivileges?
']=['queryanytableinadatabase.
','usethewithgrantoptionclause.
','logintoadatabase.
']"
"qa['examinethedescriptionofthesalestable:thesalestablehas55,000rows.examinethisstatement:whichtwostatementsaretrue?']=['sales1hasnotnullconstraintsonanyselectedcolumnswhichhadthoseconstraintsinthesalestable.
','sales1hasprimarykeyanduniqueconstraintsonanyselectedcolumnswhichhadthoseconstraintsinthesalestable.
']"
"qa['anon-correlatedsubquerycanbedefinedas__________.(choosethebestanswer.)
']=['asetofoneormoresequentialqueriesinwhichgenerallytheresultoftheinnerqueryisusedasthesearchvalueintheouterquery.
']"
